            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('treatment.update', $treatment) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="w-full mt-1 rounded">{{ $treatment->description }}</textarea>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 dark:text-gray-300">Precio</label>
                        <input type="number" name="price" step="0.01" value="{{ $treatment->price }}" class="w-full mt-1 rounded" required>
                    </div>
