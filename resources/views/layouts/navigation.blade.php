<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Servicios Link -->
                    <x-nav-link :href="route('treats')" :active="request()->routeIs('treats')">
                        {{ __('Servicios') }}
                    </x-nav-link>


                    <!-- Pedir Cita Link -->
                    <x-nav-link :href="route('newappointment')" :active="request()->routeIs('newappointment')">
                        {{ __('Pide Cita') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('myappointments')">
                            {{ __('Mis Citas') }}
                        </x-dropdown-link>
                        <!-- Authentication -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('treats')" :active="request()->routeIs('treats')">
                {{ __('Servicios') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('newappointment')" :active="request()->routeIs('newappointment')">
                {{ __('Pide Cita') }}
            </x-responsive-nav-link>
...
@auth
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('myappointments')">
                    {{ __('Mis Citas') }}
                </x-responsive-nav-link>
