<div>
    ...
    <label for="treat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selecciona el
        tratamiento</label>
    <select wire:model.live="selectedTreatment" id="treat" name="treat"
    ...
    <select id="physio" wire:model.live="selectedPhysio" name="physio"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        @if (!empty($physios))
    ...
    <div class="relative max-w-sm">
        ...
        <label for="treat" class="block mb-2  mt-4 text-sm font-medium text-gray-900 dark:text-white">Selecciona el
            día</label>
    ...
    <!-- Selección de Hora -->
<label for="time" class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white">Selecciona la hora:</label>
